function pesquisar(){
    ...
    let categoria = document.getElementById("categoriaPesquisa").value;

    if (!campoPesquisa) {
        section.innerHTML = "<p> Nada foi encontrado. Você precisa digitar um personagem, monstro ou item.</p>";
        return;
    };
    ...
    if (resultados == "") {
        section.innerHTML = '<p> Não encontrado! Selecione outra categoria ou pesquise outro nome.</p>';
    }
}